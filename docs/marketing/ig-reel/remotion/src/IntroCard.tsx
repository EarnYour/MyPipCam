...
/** Brand cold-open for vertical reel. */
export const IntroCard: React.FC = () => {
  ...
  return (
    <AbsoluteFill
      style={{
        background:
          "radial-gradient(ellipse at 28% 25%, rgba(255,94,41,0.35), transparent 52%), radial-gradient(ellipse at 75% 70%, rgba(125,223,154,0.22), transparent 48%), #111312",
